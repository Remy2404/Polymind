...
import asyncio
from src.services.media.voice_processor import VoiceProcessor, SpeechEngine, create_voice_processor, get_supported_languages
...
async def main():
    ...
    try:
        ...
        print(f"🌍 Supported languages: {len(languages['faster_whisper'])} languages for Faster-Whisper")
        ...
        print(f"🎛️ Features: Multilingual={features['multilingual']}, "
