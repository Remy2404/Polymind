    ...
    try:
        ...
        for model_id in test_models:
            if model_id in all_models:
                ...
                logger.info(f"  - OpenRouter key: {config.openrouter_model_key or 'N/A'}")
        ...
        if "llama-3.3-8b" in all_models:
            ...
            logger.info(f"  - System message: {llama_config.system_message[:100] if llama_config.system_message else 'None'}...")
