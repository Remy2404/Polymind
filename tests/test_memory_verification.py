...
async def test_memory_context_simple():
    ...
    try:
        ...
        logger.info(
            "  ✅ Voice messages should use: user_806762900_model_deepseek-r1-0528"
        )
        logger.info(
            "  ✅ Text messages should use: user_806762900_model_deepseek-r1-0528"
        )
        ...
        logger.info(
            "  1. Removed duplicate save_media_interaction() call from voice handler"
        )
        logger.info(
            "  2. Voice messages now use save_message_pair() like text messages"
        )
