...
async def test_long_context_generation():
    ...
    test_models = [
        ...
        ("deepseek-r1-zero", "DeepSeek"),  # Fixed: use correct model ID that maps to deepseek-r1-distill-llama-70b
        ...
        try:
            ...
            if response and not response.startswith("❌"):
                ...
                if len(response) > 2000:
                    ...
                    print(f"   ⚠️  Response seems shorter than expected for comprehensive tutorial")
            else:
