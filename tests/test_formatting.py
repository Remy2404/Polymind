...
async def test_voice_formatting():
    ...
    ai_response = "Absolutely! Based on our current conversation — yes, your name is **Rami**! 😊"
    ...
    try:
        markdown_converted = await formatter.format_telegram_markdown(voice_formatted_response)
        print("\nMarkdown converted:")
