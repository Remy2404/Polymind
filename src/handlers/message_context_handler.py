...
class MessageContextHandler:
    ...
    def extract_reply_context(self, message: Message) -> Tuple[Optional[str], Optional[int]]:
        """
        ...
        if message.reply_to_message.text:
            ...
            quoted_text = f"[Image/Document with caption: {message.reply_to_message.caption}]"
        elif message.reply_to_message.photo:
            quoted_text = "[Image without caption]"
        elif message.reply_to_message.document:
            quoted_text = f"[Document: {message.reply_to_message.document.file_name}]"
        elif message.reply_to_message.voice:
            quoted_text = "[Voice message]"
        elif message.reply_to_message.sticker:
            quoted_text = f"[Sticker: {getattr(message.reply_to_message.sticker, 'emoji', '😊')}]"
        elif message.reply_to_message.animation:
            quoted_text = "[GIF/Animation]"
        elif message.reply_to_message.video:
            quoted_text = "[Video]" + (f" with caption: {message.reply_to_message.caption}" if message.reply_to_message.caption else "")
        else:
    ...
    def format_response_with_quote_indicator(self, response: str, model_indicator: str, is_reply: bool = False) -> str:
        """
