...
class CallbackDataMapper:
    ...
    def get_model_id(self, callback_data: str) -> Optional[str]:
        ...
        """
        # Remove the prefix (e.g., "model_", "category_")
    ...
    def _create_short_id(self, model_id: str) -> str:
        ...
        # Try different strategies for creating short IDs
        
        # Strategy 1: Use provider and key parts
        if "/" in model_id:
            ...
            model_part = model_part.replace(":free", "").replace("-instruct", "").replace("-preview", "")
            ...
            # Fallback: use first 15 characters
