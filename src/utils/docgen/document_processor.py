...
class DocumentProcessor:
    ...
    def __init__(self, gemini_api: GeminiAPI):
        ...
        self.supported_extensions = {
            ...
            # Text formats
            "txt", "csv", "html", "md", "json", "xml", "rtf",
            # Code files
            "py", "js", "ts", "java", "cpp", "c", "cs", "php", "rb", 
            "go", "rs", "sql", "sh", "yaml", "yml"
        }
    ...
    async def process_document(
        ...
        try:
            ...
            if result.success:
                ...
                self.logger.error(f"Failed to process document {filename}: {result.error}")
    ...
    async def process_multiple_documents(
        ...
        try:
            ...
            if result.success:
                ...
                self.logger.error(f"Failed to process multiple documents: {result.error}")
    ...
    def get_document_info(self, filename: str) -> Dict[str, str]:
        ...
        categories = {
            ...
            "code": {"py", "js", "ts", "java", "cpp", "c", "cs", "php", "rb", "go", "rs", "sql", "sh", "yaml", "yml"}
        }
        ...
        for category, extensions in categories.items():
            if extension in extensions:
                return {
                    "type": extension,
                    "category": category,
                    "language": self._detect_language(extension) if category == "code" else None
                }
