"""
Document Processor for handling document processing using the Gemini API.
"""
import asyncio
import io
import json
...
from .shared_imports import logging, GEMINI_API_KEY
...
class DocumentProcessor:
    ...
    async def process_document_enhanced(
        ...
        try:
            ...
            # Use Gemini 2.0 Flash for best document processing results
